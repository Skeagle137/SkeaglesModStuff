...
@OnlyIn(Dist.CLIENT)
public class MilkBubbleParticle  extends SpriteTexturedParticle {
    private MilkBubbleParticle(ClientWorld world, double x, double y, double z, double motionX, double motionY, double motionZ) {
        super(world, x, y, z);
    ...
    public static class Factory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle makeParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            MilkBubbleParticle bubbleparticle = new MilkBubbleParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
