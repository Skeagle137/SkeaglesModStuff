...
public class SMSBlocks {
    ...
    public static final RegistryObject<LiquidBlock> MILK_FLUID_BLOCK = BLOCKS.register("milk_fluid_block",
            () -> new LiquidBlock(SMSFluids.MILK, BlockBehaviour.Properties.of(Material.WATER).noCollission().strength(100.0F).noDrops()));

    //normal blocks
    @MakeBlockItem @DropLoot
    public static final RegistryObject<Block> DUCK_BLOCK = BLOCKS.register("duckblock", DuckBlock::new);
    @ItemModel
    public static final RegistryObject<CakeBlock> DUCK_CAKE = BLOCKS.register("duckcake", DuckCake::new);
    /*@MakeBlockItem
