package net.skeagle.skeaglesmodstuff.gui;
...
public class MegaWorkBenchContainer extends Container {
    ...
    public MegaWorkBenchContainer(int id, PlayerInventory playerInventory) {
        this(id, playerInventory, IWorldPosCallable.DUMMY);
    }

    public MegaWorkBenchContainer(int id, PlayerInventory playerInventory, IWorldPosCallable worldPosCallable) {
        ...
        for (int i = 0; i < 5; ++i) {
            for(int j = 0; j < 5; ++j) {
                this.addSlot(new Slot(this.craftMatrix, j + i * 5, 30 + j * 18, 17 + i * 18));
            }
        }
